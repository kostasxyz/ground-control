...
const PATHS = {
  ...
  /* lucide folder-open */
  'folder-open': (
    <path d="m6 14 1.45-2.32A1 1 0 0 1 8.29 11H20a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h7a1 1 0 0 1 .707.293l2.293 2.293A1 1 0 0 0 15 8h6" />
  ),
  /* lucide code */
  code: (
    <>
